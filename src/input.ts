...
const KEY_MAP: Record<string, Action> = {
  ...
  a: 'left', A: 'left', d: 'right', D: 'right', w: 'aimUp', W: 'aimUp', s: 'aimDown', S: 'aimDown',
  ' ': 'fire', Enter: 'jump', Backspace: 'endTurn', Escape: 'endTurn',
  '1': 'weapon1', '2': 'weapon2', '3': 'weapon3', '4': 'weapon4', '5': 'weapon5',
  '6': 'weapon6', '7': 'weapon7', '8': 'weapon8', '9': 'weapon9', '0': 'weapon10',
};
...
const WEAPON_NUMBERS: Partial<Record<Action, number>> = {
  ...
  weapon6: 6, weapon7: 7, weapon8: 8, weapon9: 9, weapon10: 10,
};
